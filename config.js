...
module.exports = {
    ...
    CAPTIONS: process.env.CAPTIONS === undefined ? 'Made By 👩‍🦰Professor' : process.env.CAPTIONS,
    DISBGM: process.env.DISABLE_JID_BGM_FILTER === undefined ? false : process.env.DISABLE_JID_BGM_FILTER,
    STICKERP: process.env.AUTO_STICKER === undefined ? true : convertToBool(process.env.AUTO_STICKER),
    DISSTICKER: process.env.DISABLE_STICKER === undefined ? false : process.env.DISABLE_STICKER,
    BOT_NAME: process.env.BOT_NAME === undefined ? '👩‍🦰Jin' : process.env.BOT_NAME,
    ...
    AMAZONE: process.env.AMAZONE === undefined ? 'Professor Jin' : process.env.AMAZONE,
    KTB: process.env.TAG_HEADER === undefined ? 'Jin' : process.env.TAG_HEADER,
    FAKE_REMOVER: process.env.FAKE_REMOVER === undefined ? 'true' : process.env.FAKE_REMOVER,
    OWN: process.env.OWN === undefined ? 923034757172' : process.env.OWN,
    ...
    PANEL_COMMAND: process.env.PANEL_COMMAND === undefined ? 'jin' : process.env.PANEL_COMMAND,
    ...
    MENU_INFO: process.env.MENU_INFO === undefined ?'ᴘʀᴏꜰᴇꜱꜱᴏʀ ᴊɪɴ ɪꜱ ᴀ ᴘᴏᴡᴇʀꜰᴜʟʟ ʙᴏᴛ ꜰᴏʀ ᴡʜᴀᴛꜱᴀᴘᴘ. ᴅᴇᴠᴇʟᴏᴘᴇᴅ ʙʏ ★彡[ᴘʀᴏꜰᴇꜱꜱᴏʀ]彡★ Use ᴇᴀꜱʏ ᴀɴᴅ ᴡᴏʀᴋɪɴɢ ᴘᴇʀᴇᴄᴛʟʏ..ꜱᴏ ᴘʀᴏꜰᴇꜱꜱᴏʀ ᴊɪɴ ɪꜱ ʙᴇꜱᴛ ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ!!' : process.env.MENU_INFO,
    BRANCH: 'master',
    HEROKU: {
